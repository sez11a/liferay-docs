...
<!-- The paragraph below was written before Liferay 7 and to move to OSGi. Need to check with developers regarding this paragraph's accuracy for 7. Which classes, as of 7, are scanned for the @JSONWebService annotations? Also, we shouldn't use the terms 'plugins' and 'portlets', we should use 'applications' and 'modules' instead. -->
...
<!-- I assume that the Service Builder plugin now performs the function that the Plugins SDK performed in 6.2. Check with devs. -->
