...
selectable? Easy! Use *portlet model hints*! Liferay Service Builder's model
hints provide a single place in your application where you can specify entity
data restrictions. Model hints are specified in a single file called
...
Let's look at a sample model hints file generated by Service Builder:
...
`portal-model-hints.xml` which is in Liferay's `portal-impl/src/META-INF`
