...
**File Upload:** Allows the user to upload a document from their computer to the document library to attach to the data record. The upload can be constrained to a containing folder inside the document library, or to the user's default upload location.
