...
One final option, if you have a budget, is to buy something that mostly fits what you want to do, with the intention of customizing it to fit your needs. It's the customization--particularly with products that are not open source--that can be most difficult. License agreements need to be negotiated to get you access to non-documented, internal APIs, and many products are simply not designed to be customized to the extent that you might want to have them customized. Many times, you wind up having to pay expensive consultants to get the result that you want, and after that, you have a complicated situation when it comes to upgrading your system. 
