...
## JSONWSサービスのスコープの作成[](id=creating-a-scope-for-a-jsonws-service)
...
## JAX-RSサービスのスコープの作成[](id=creating-a-scope-for-a-jax-rs-service)
...
## 認可ページの作成[](id=creating-the-authorization-page)
