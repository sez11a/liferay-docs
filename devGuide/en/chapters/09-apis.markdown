...
## Device Detection [](id=lp-6-1-dgen09-device-detection-0)
...
### Using the Device API [](id=lp-6-1-dgen09-using-the-device-api-0)
...
### Device capabilities [](id=lp-6-1-dgen09-device-capabilities-0)
