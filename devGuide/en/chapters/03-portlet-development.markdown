...
***To deploy in Developer Studio*** - Simply drag your portlet project onto your server. Upon deploying your template, your server will output messages indicating that your template was read, registered and is now available for use.
