package com.liferay.docs.headless.guestbook.dto.v1_0;
...
public class GuestbookEntry {
	...
	@Schema(description = "A user-enterable email.")
	...
	@Schema(description = "The guestbook entry's ID")
	public String getId() {
		return id;
	}
	...
	@Schema(description = "A message for the guestbook.")
	...
	@Schema(description = "A user-enterable name.")
	...
	public String toString() {
		...
		if (guestbook != null) {
			...
			sb.append(String.valueOf(guestbook));
		}
