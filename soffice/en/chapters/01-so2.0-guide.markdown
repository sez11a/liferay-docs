...
- microblogs-portlet
- portal-compat-hook (EE-only)
- private-messaging-portlet
- resource-importer
- so-configurations-portlet (EE-only)
- so-hook
- so-portlet
- so-theme
- so-welcome-theme
...
![Figure 1.5: Tip](../../images/tip.png) **Warning:** When you start Liferay for
